...
const App: React.FC = () => {
  ...
  const [generationStatus, setGenerationStatus] = useState<'script' | 'images' | null>(null);
              ...
              {isLoading && (
                <div className="flex flex-col items-center justify-center h-full min-h-[600px] rounded-2xl">
                  ...
                  <p className="text-gray-300 text-lg">
                    {generationStatus === 'script' ? 'Generating viral script...' : 'Crafting visuals for each scene...'}
                  </p>
              ...
              {videoScript && (
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 animate-fade-in">
                  <div className="xl:col-span-2">
                      <VideoPreview videoScript={videoScript} sceneImages={sceneImages} isGeneratingImages={isGeneratingImages} />
                  </div>
